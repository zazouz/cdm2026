  ...
  return (
    <LanguageProvider>
      <div className="relative min-h-screen flex flex-col bg-gray-950">
        <div className="pointer-events-none fixed inset-0 z-0" style={{ backgroundImage: "url('/bg-fifa-2026.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.2 }} />
